...
SELECT pg_catalog.setval('public.retailpoints_retailid_seq', 1, false);
...
SELECT pg_catalog.setval('public.stockin_stockinid_seq', 1, false);
...
SELECT pg_catalog.setval('public.stockrequest_requestid_seq', 1, false);
...
SELECT pg_catalog.setval('public.warehouses_warehouseid_seq', 1, false);
